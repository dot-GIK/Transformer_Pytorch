...
model = Transformer(num_tokens=9000, dim_model=128, num_heads=8, num_encoder_layers=6, num_decoder_layers=6, dropout_p=0.1).to(device)
...
train_loss_list, validation_loss_list = fit(model, opt, loss_fn, dataset, dataset, 1000)
